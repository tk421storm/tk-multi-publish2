...
"}")
		...
		self.updateTask=QtGui.QComboBox()
		model=self.updateTask.model()
		for name in ['Review', 'In Progress']:
			item=QtGui.QStandardItem(name)
			model.appendRow(item)
		self.taskLayout.addWidget(self.updateTask, 0, 2)
