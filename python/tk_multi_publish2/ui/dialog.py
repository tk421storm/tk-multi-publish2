...
"}")
		...
		self.drop_area_browse_file.setMinimumSize(QtCore.QSize(150, 85))
		...
		self.drop_area_browse_seq.setMinimumSize(QtCore.QSize(150, 85))
		...
		#make required delivery settings
		
		#name
		self.deliveryName=QtGui.QLineEdit()
		self.deliveryName.setMaximumWidth(250)
		deliveryNameLabel=QtGui.QLabel('Name: ')
		deliveryNameLabel.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignBottom)
		
		deliveryLayout.addWidget(deliveryNameLabel, 0, 0)
		deliveryLayout.addWidget(self.deliveryName, 0, 1)
		...
		deliveryLayout.addWidget(deliveryTypeLabel, 1, 0)
		deliveryLayout.addWidget(self.deliveryType, 1, 1)
		
		
		#method
		deliveryMethodLabel=QtGui.QLabel('Method: ')
		deliveryMethodLabel.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignBottom)
		self.deliveryMethod=QtGui.QComboBox()
		Dialog.deliveryMethods.connect(self.updateDeliveryMethods)
		
		deliveryLayout.addWidget(deliveryMethodLabel, 2, 0)
		deliveryLayout.addWidget(self.deliveryMethod, 2, 1)
		
		#description
		deliveryDescriptionLabel=QtGui.QLabel('Description: ')
		deliveryDescriptionLabel.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignTop)
		self.deliveryDescription=QtGui.QTextEdit()
		self.deliveryDescription.setMaximumWidth(250)
		self.deliveryDescription.setMaximumHeight(55)
