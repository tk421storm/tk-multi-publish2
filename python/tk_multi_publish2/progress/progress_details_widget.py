...
class ProgressDetailsWidget(QtGui.QWidget):
    ...
    def __init__(self, parent):
        ...
        self.ui.submit_bug_report.clicked.connect(self.submit_bug_report)
    ...
    def submit_bug_report(self, event=None):
        '''launch the bug submit panel'''
        #parent=self.parent()
        #print "parent: "+str(parent.objectName())
        #while parent:
        #    parent=parent.parent()
        #    print "parent: "+str(parent.objectName())
        #print "launching bug submit from "+str(self.parent().parent().parent().parent())
        self.parent().parent().parent().parent().showBugSubmit.emit('Manual submission from log window')
